<?php
  ...
  $dataSatuan = $conn->query("SELECT * FROM satuan WHERE id_satuan = '$_GET[id_satuan]'");
  $satuan = $dataSatuan->fetch_assoc();
          ...
          <section class="wrapper">
            ...
            <hr>
              ...
              <div class="col-lg-2">
                  ...
                  <form class="form-horizontal style-form" method="post" action = <?php echo "\"act/edit_satuan.php?id_satuan=$satuan[id_satuan]\""?>>

                    <!--nama_dokter-->
                    <div class="form-group">
                      <label class="col-sm-2 col-sm-2 control-label">Nama Satuan</label>
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="nama_satuan" id="nama_satuan" value=<?php echo "\"$satuan[nama_satuan]\"";?> autocomplete="off" required>
                      </div>
                    </div>
